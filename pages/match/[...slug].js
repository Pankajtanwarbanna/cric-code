  ...
  return (
    <div className="container">
      ...
      <div className="editor">
          ...
          <div id="page" contentEditable={true} suppressContentEditableWarning={true}> 
            &lt;<span className="pink">!DOCTYPE</span> <span className="green">html</span>&gt;<br />
            &lt;<span className="pink">title</span>&gt;{match.title} - CricCode&lt;/<span className="pink">title</span>&gt;<br />
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="lightblue">// more at <a contentEditable="false" href="https://www.cricbuzz.com/">cricbuzz.</a></span>
            <br /></span>
            ...
            <span className="grey">
            &lt;!--
            Built with ❤️ by <a contentEditable="false" href="https://www.pankajtanwar.in/">Pankaj Tanwar</a>. Reach out to him at <a contentEditable="false" href="https://twitter.com/the2ndfloorguy">twitter!</a>
            --&gt;<br />
            </span>
            <br />
            <br />
