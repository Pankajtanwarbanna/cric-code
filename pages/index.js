    ...
    <div className="container">
      ...
      <div className="editor">
          ...
          <div id="page" suppressContentEditableWarning={true} contenteditable> 
            ...
            <span className="grey">
            &lt;!--
            Checkout live matches, recent matches and upcoming matches at one place. Built by <a contentEditable="false" href="https://www.pankajtanwar.in/">Pankaj Tanwar</a>.
             --&gt;<br />
            </span>
            &lt;<span className="pink">style</span>&gt;<br />
            {
              matches.map((match) => (                
                <div>
                  &nbsp;&nbsp;&nbsp;&nbsp;<span className="grey">&lt;!-- { match.match_category } --&gt;<br /></span>
                  &nbsp;&nbsp;&nbsp;&nbsp;<span className="pink">div</span>[<span className="green">id</span><span className="pink">=</span><span className="yellow">"{ `${match.matchType}-match`}"</span> <span className="green">title</span><span className="pink">=</span><span className="yellow">"{ match.updates[0] }"</span>]
                  {' {'}<br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="lightblue">score-board</span>: <span className="lightpurple">'{ match.updates[1] }'</span><br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="lightblue">score-board</span>: <span className="lightpurple">'{ match.updates[2] }'</span>;<br />
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="lightblue">commentary</span>: <a className="yellow" contentEditable="false" href={ `/match/${format_slug(match.matchUrl)}` }>'Checkout commentary'</a>;<br />
                  &nbsp;&nbsp;&nbsp;&nbsp;
                  {'}'}
                  <br />
                  <br />
