  ...
  return (
    <div className="container">
      ...
      <div className="editor">
        ...
        <div id="page" suppressContentEditableWarning={true}>
          ...
          <span className="grey">
            &lt;!--
            Checkout live matches, recent matches and upcoming matches at one place. Built by <a href="https://www.pankajtanwar.in/">Pankaj Tanwar</a>.
            --&gt;<br />
          </span>
          &lt;<span className="pink">style</span>&gt;<br />
          {
            matches.map((match) => (
              <div>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="lightblue">commentary</span>: <a className="yellow" href={`/match/${format_slug(match.matchUrl)}`}>'Checkout commentary'</a>;<br />
                &nbsp;&nbsp;&nbsp;&nbsp;
                {'}'}
                <br />
                <br />
